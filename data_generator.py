...
Try to add more multiprocessing to speed up training as well testing
"""
...
class DataGenerator(object):
    ...
    def featurize(self, audio_clip):
        """ 
        Given a audio file, it calculates and returns the mfcc with default configurations
        """
        
        sample_rate, clip = wavfile.read(audio_clip)
        a = mfcc(clip, nfft = 1500, samplerate = sample_rate)
        return a

    def load_metadata_from_desc_file(self, desc_file, partition='train', max_duration = 15):
